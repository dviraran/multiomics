...
if (is.null(params$commentary_tbl)) {
  tryCatch({
  ...
  commentary_tbl <- params$commentary_tbl
}
...
render_commentary <- function(figure_id, commentary_tbl) {
  ...
  if (!is.null(commentary$what_is_this) && nchar(commentary$what_is_this) > 0) {
    html <- paste0(html, '<div class="commentary-what-is-this">',
...
```{r mofa-commentary, eval=mofa_available, results='asis'}
...
```{r diablo-commentary, eval=diablo_available, results='asis'}
...
```{r snf-commentary, eval=snf_available, results='asis'}
...
```{r concordance-commentary, eval=rp_available, results='asis'}
