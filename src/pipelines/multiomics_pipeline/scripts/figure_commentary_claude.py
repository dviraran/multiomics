...
This script analyzes multi-omics integration pipeline figures using Claude's vision
...
def main():
    parser = argparse.ArgumentParser(description="Generate figure commentary using Claude Vision API")
